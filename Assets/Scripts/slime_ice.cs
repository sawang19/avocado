...
public class slime_ice : Enemy
{
    ...
    void OnTriggerEnter2D(Collider2D hitInfo)
    {
        ...
        if (hitInfo.CompareTag("Player") || hitInfo.CompareTag("bullet_p1") || hitInfo.CompareTag("icesword") || hitInfo.CompareTag("auto") || hitInfo.CompareTag("reaper"))
        {
